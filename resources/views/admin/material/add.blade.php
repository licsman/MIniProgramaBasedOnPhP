...
<div style="width: 1200px; height: 1600px;margin-top: 20px">
    @if(count($errors)>0)
        ...
        @endforeach
    @endif
    <form class="layui-form" action="{{secure_url('admin/material')}}" method="post">
        <input type="hidden" name="_token" class="tag_token" value="{{csrf_token()}}">
        <div class="layui-form-item">
            <label class="layui-form-label">资料名称</label>
            <div class="layui-input-block">
                <input type="text" name="material_name"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="material_description"   lay-verify="required" placeholder="请输入内容" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">资料编辑区</label>
            <div class="layui-input-block" id="layui-input-block1">
                <textarea id="content_demo" name="material_content" style="display: none;"></textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="material_editor"  lay-verify="required" placeholder="编辑昵称" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">资料缩略图URL</label>
            <div class="layui-input-block">
                <input id="material_thumb" type="text" name="material_thumb" placeholder="上传后自动填写，支持jpg gif png等图片格式" value="" class="layui-input">
            </div>
