...
<div style="width: 1200px;margin-top: 20px">
    @if(count($errors)>0)
        ...
        @endforeach
    @endif
    <form class="layui-form" action="{{secure_url('admin/category')}}" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="cate_title"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
